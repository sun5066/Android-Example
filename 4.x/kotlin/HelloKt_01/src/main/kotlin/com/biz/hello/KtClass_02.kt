...
/**
 * kotlin 에서의 클래스
 * kotlin 에서는 필드변수(속성, 인스턴스변수)를 생성자와 함께
 * 선언하고 초기화 할 수 있다.
 * */
...
// 속성 name, age 에 접근 가능
// 단!
// name val 로 선언되어서 읽기 전용으로만!
//      obj : Class_02 = Class_02()
//      var n = obj.name 가능
//      obj.name = "홍길동"
//      var a = obj.age 가능
//      obj.age = 30 가능
class Class_02(val name: String, val age: Int) {}

// 속성에 기본값을 지정하여 객체를 만들때
// 변수 값이 주입되지 않으면 기본값으로 변수를 초기화
// var obj = Class_03("이몽룡", 33) : name 속성과 age 를 정의
// var obj = Class_03() : name 은 홍길동, age 는 0으로 초기화 된다.
class Class_03(val name: String = "홍길동", val age: Int = 0) {}

// KT 은 기본적으로 Class 의 상속이 금지된다.
